...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/tpladmin.dwt.php" codeOutsideHTMLIsLocked="false" -->
	<head>
		...
		<script language="javascript" type="text/javascript" src="../../javascript/deleta_time.js"></script>
		<!-- InstanceEndEditable -->
	</head>
	...
	<body>
		<div id="geral">
			...
			<div id="conteudo">
				...
				<h2>Consulta por nome os times</h2>
				
				<form method="get" action="consulta.nometime.php"
				name="frmConsulta" id="frmConsulta">
					...
					<table width="80%" class="lista">
						...
						if (isset($_GET['btnConsultar'])) {						
							...
							$vetor = Time :: listarPorNome($_GET['txtNome']);
