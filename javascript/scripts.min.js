...
var xhr=Ajax.createXHR();if(xhr!=undefined){xhr.open("POST","http://localhost/sistemaRest/api/v1/controller/categoria.php?a=3",!0);xhr.onload=function(e){if(xhr.readyState=='4'){var json=JSON.parse(xhr.responseText);var table=document.getElementById("tabela");table.innerHTML="";var len=0;if(json.categorias!=null){len=json.categorias.length}
...
var xhr=Ajax.createXHR();if(xhr!=undefined){xhr.open("POST","http://localhost/sistemaRest/api/v1/controller/divisao.php?a=3",!0);xhr.onload=function(e){if(xhr.readyState=='4'){var json=JSON.parse(xhr.responseText);var table=document.getElementById("tabela");table.innerHTML="";var len=0;if(json.divisaos!=null){len=json.divisaos.length}
...
var xhr=Ajax.createXHR();if(xhr!=undefined){xhr.open("POST","http://localhost/sistemaRest/api/v1/controller/tecnico.php?a=3",!0);xhr.onload=function(e){if(xhr.readyState=='4'){var json=JSON.parse(xhr.responseText);var table=document.getElementById("tabela");table.innerHTML="";var len=0;if(json.tecnicos!=null){len=json.tecnicos.length}
...
static consultar(form){var pesquisa='';if(form!=null&&form.txtNome.value!=undefined){pesquisa=form.txtNome.value}
var xhr=Ajax.createXHR();if(xhr!=undefined){var uri="http://localhost/sistemaRest/api/v1/controller/time.php";var params="a=2";xhr.open("POST",uri+"?"+params,!0);xhr.onload=function(e){if(xhr.readyState=='4'){var json=JSON.parse(xhr.responseText);var table=document.getElementById("tabela");table.innerHTML="";var len=0;if(json.times!=null){len=json.times.length}
...
xhr.send()}else{alert(mensagem)}}}
static listaTodosTimes(){var xhr=Ajax.createXHR();if(xhr!=undefined){xhr.open("GET","http://localhost/sistemaRest/api/v1/controller/time.php",!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){if(xhr.readyState=='4'){var json=JSON.parse(xhr.responseText);var len=0;if(json.times!=undefined){var len=json.times.length}
