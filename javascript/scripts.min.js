...
if(xhr!=undefined){xhr.open("POST","http://localhost/sistemaRest/api/v1/controller/categoria.php?a=3"+consulta,!0);xhr.onload=function(e){if(xhr.readyState=='4'){var json=JSON.parse(xhr.responseText);var table=document.getElementById("tabela");table.innerHTML="";var len=0;if(json.categorias!=null){len=json.categorias.length}
...
if(mensagem==""&&xhr!=undefined){xhr.open("GET","http://localhost/sistemaRest/api/v1/controller/categoria.php?a=6"+codigo+consulta,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){if(xhr.readyState=='4'&&xhr.status=='200'){document.getElementById("ajax-loader").style.display='none';location.reload();var json=JSON.parse(xhr.responseText);alert(json.mensagem)}}
...
var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
if(mensagem==""&&xhr!=undefined){xhr.open("POST","http://localhost/sistemaRest/api/v1/controller/categoria.php?a=4"+consulta,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){if(xhr.readyState=='4'&&xhr.status=='200'){document.getElementById("txtNome").value="";var json=JSON.parse(xhr.responseText);document.getElementById("mensagem").innerHTML=json.mensagem}}
...
var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
if(mensagem==""&&xhr!=undefined){xhr.open("POST","http://localhost/sistemaRest/api/v1/controller/categoria.php?a=5"+codigo+consulta,!0);xhr.setRequestHeader("Content-Type","application/json;charset=UTF-8");xhr.onreadystatechange=function(){if(xhr.readyState=='4'&&xhr.status=='200'){var json=JSON.parse(xhr.responseText);document.getElementById("mensagem").innerHTML=json.mensagem}}
...
static confirmar(codigo){var xhr=Ajax.createXHR();var ok=window.confirm("Você tem certeza que deseja excluir?");if(ok&&xhr!=undefined){var mensagem="";if(codigo==""){mensagem+="Código invalido"}else{codigo="&id="+codigo}
var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
...
xhr.send()}else{alert(mensagem)}}}
static cadastrar(form){var xhr=Ajax.createXHR();if(Tecnico.valida()==!1){return !1}
...
xhr.send()}}
static listaNomePorCodigo(codigoParam){var xhr=Ajax.createXHR();var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
...
xhr.send()}}
static carregaDivisao(codigo){var xhr=Ajax.createXHR();var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
...
xhr.send()}}
static carregaCategoria(codigo){var xhr=Ajax.createXHR();var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
if(xhr!=undefined){if(codigo!=undefined){codigo="&id="+codigo}else{codigo=""}
...
xhr.send()}}
static carregaTecnico(codigo){var xhr=Ajax.createXHR();var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
if(xhr!=undefined){if(codigo!=undefined){codigo="&id="+codigo}else{codigo=""}
...
document.getElementById("destino").innerHTML=dhtml}};class Torcedor{static formToJSON(form){var codigo='';var txtNome='';var txtLogin='';var txtEmail='';var txtSenhaAtual='';var txtSenha='';var txtConfSenha='';if(form.codigo!=undefined){codigo=form.codigo.value}
if(form.txtNome!=undefined){txtNome=form.txtNome.value}
...
static atualizar(form){document.getElementById("mensagem").innerHTML="<br /><b>Aguarde...</b>";var xhr=Ajax.createXHR();var mensagem="";if(form.txtNome.value==""){mensagem+="<br /><b>Você não preencheu a técnico</b>"}
var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
