...
document.getElementById("destino").innerHTML=dhtml}};class Torcedor{static formToJSON(form){var codigo='';var txtNome='';var txtLogin='';var txtEmail='';var txtSenhaAtual='';var txtSenha='';var txtConfSenha='';if(form.id!=undefined){codigo=form.id.value}
...
static insereDadosTorcedorRetornados(codigo){var xhr=Ajax.createXHR();var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
