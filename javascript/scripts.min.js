...
if((document.getElementById("cmbDia").value=="29")&&(document.getElementById("cmbMes").value=="02")){if((document.getElementById("cmbAno").value%4!="use strict")||(document.getElementById("cmbAno").value%100!="use strict")||(document.getElementById("cmbAno").value%400!="use strict")){strErro=strErro+"\nEste ano não é bissexto."}}
