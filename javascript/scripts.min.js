...
static confirmar(codigo){var ok=window.confirm("Voce tem certeza que deseja excluir?");if(ok){document.getElementById("ajax-loader").style.display='block';var mensagem="";if(codigo==""){mensagem+="Código invalido"}else{codigo="&id="+codigo}
var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
if(mensagem==""){linkReq.open("POST","http://localhost/sistemaRest/api/v1/categoria/index.php?a=6"+codigo+consulta,!0);linkReq.setRequestHeader('Content-Type','application/x-www-form-urlencoded');linkReq.onreadystatechange=function(){if(linkReq.readyState=='4'&&linkReq.status=='200'){document.getElementById("ajax-loader").style.display='none';location.reload();var json=JSON.parse(linkReq.responseText);alert(json.mensagem)}}
linkReq.send()}else{alert(mensagem)}}}
...
var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
if(mensagem==""){linkReq.open("POST","http://localhost/sistemaRest/api/v1/divisao/index.php?a=6"+codigo+consulta,!0);linkReq.setRequestHeader('Content-Type','application/x-www-form-urlencoded');linkReq.onreadystatechange=function(){if(linkReq.readyState=='4'){var json=JSON.parse(linkReq.responseText);alert(json.mensagem);location.reload()}}
linkReq.send()}else{alert(mensagem)}}}
...
static confirmar(codigo){var ok=window.confirm("Voce tem certeza que deseja excluir?");if(ok){var mensagem="";if(codigo==""){mensagem+="Código invalido"}else{codigo="&id="+codigo}
var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
if(mensagem==""){linkReq.open("POST","http://localhost/sistemaRest/api/v1/tecnico/index.php?a=6"+codigo+consulta,!0);linkReq.setRequestHeader('Content-Type','application/x-www-form-urlencoded');linkReq.onreadystatechange=function(){if(linkReq.readyState=='4'){var json=JSON.parse(linkReq.responseText);alert(json.mensagem);location.reload()}}
linkReq.send()}else{alert(mensagem)}}}
...
static confirmar(codigo){var ok=window.confirm("Voce tem certeza que deseja excluir?");if(ok){var mensagem="";if(codigo==""){mensagem+="Código invalido"}else{codigo="&id="+codigo}
var token=Login.getCookie('token');var consulta="";if(token!==""){consulta="&tk="+token}
if(mensagem===""){linkReq.open("POST","http://localhost/sistemaRest/api/v1/time/index.php?a=5"+codigo+consulta,!0);linkReq.setRequestHeader('Content-Type','application/x-www-form-urlencoded');linkReq.onreadystatechange=function(){if(linkReq.readyState=='4'){var json=JSON.parse(linkReq.responseText);alert(json.mensagem);location.reload()}}
linkReq.send()}else{alert(mensagem)}}}
