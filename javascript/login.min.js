...
return ""}
function valida(){var strErro="";var usuario=document.getElementById("txtTorcedor").value;var senha=document.getElementById("txtSenha").value;if(usuario===""){strErro=strErro+"\nVoce Nao Preencheu o Login"}
if(senha===""){strErro=strErro+"\nVoce Nao Preencheu a Senha"}
if(strErro!==""){alert(strErro);return !1}else{var hash=CryptoJS.MD5((usuario+""+senha));if(getCookie('token')===""){createCookie('token',hash,1)}}}